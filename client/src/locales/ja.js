export default {
  ...
  restocking: {
    title: '在庫補充',
    subtitle: '予算を設定し、需要予測に基づく推奨補充数量を確認します',
    budget: '利用可能予算',
    totalCost: '合計費用',
    remaining: '残り',
    recommendations: '推奨アイテム',
    placeOrder: '発注する',
    orderPlaced: '補充注文 {n} を送信しました',
    excludedHint: 'グレー表示のアイテムは現在の予算を超えています',
    noItems: '補充するアイテムがありません',
    table: {
      sku: 'SKU',
      name: 'アイテム',
      category: 'カテゴリ',
  ...
  reports: {
    title: '業績レポート',
    description: '四半期業績指標と月次トレンドを確認します',
